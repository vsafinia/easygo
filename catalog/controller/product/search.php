...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		foreach($groups as $type){
			$data['groups'][] = array(
					'id'=>$type['customer_group_id'],
					'name'=>$type['name'],
					'value'=>$type['name'],
					'selected'=>(isset($group) && $group==$type['name'])?'selected':''
			);
		}
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag']) || isset($this->request->get['route'])) {
			$filter_data = array(
				'filter_name'         => $search,
				'filter_type'         => $group,
				'filter_tag'          => $tag,
