...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_bidding_status'])) {
			$data['config_bidding_status'] = $this->request->post['config_bidding_status'];
		} else {
			$data['config_bidding_status'] = $this->config->get('config_bidding_status');
		}
...
//		);
		...
		$data['mail_alerts'][] = array(
			'text'  => $this->language->get('text_mail_bidding'),
			'value' => 'bidding'
		);
	...
	public function theme() {
		...
		}else if ($this->request->get['theme'] == 'theme_easygo') {
            $theme = $this->config->get('theme_easygo_directory');
        } else {
