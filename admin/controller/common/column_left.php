...
/*			if ($this->user->hasPermission('access', 'catalog/manufacturer')) {
		...
		/*	if ($this->user->hasPermission('access', 'catalog/download')) {
			...
			if ($this->user->hasPermission('access', 'catalog/bidding')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_bidding'),
					'href'     => $this->url->link('catalog/bidding', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
