...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$data['products'][] = array(
				...
				'name'       => $result['name'],
				'type'       => $result['type'],
				'type_link'  => $this->url->link('customer/customer/edit', 'token=' . $this->session->data['token'] . '&customer_id=' . $result['customer_id'], true),
				'model'      => $result['model'],
				'price'      => $result['price'],
				'special'    => $special,
	...
	protected function getForm() {
		...
		if($data['customer_id']){
			...
			$customer_group = $this->model_customer_customer_group->getCustomerGroup($customer_info['customer_group_id']);
			$data['customer'] = $customer_info['firstname'].' '.$customer_info['lastname'];
			$data['type'] = $customer_group['name'];
