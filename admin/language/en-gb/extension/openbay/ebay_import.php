...
// Text
$_['text_sync_import_line1']     = '<strong>Caution!</strong> This will import all of your eBay Packages and build a Group structure in your store. It is advised that you delete all categories and Packages before you run this option. <br />The Group structure is from the normal eBay categories, not your shop categories (if you have an eBay shop). You can rename, remove and edit the imported categories without affecting your eBay Packages.';
...
$_['text_import_confirm']		 = 'This will import all of your eBay items as new Packages, are you sure? This CAN NOT be undone! ENSURE you have a backup first!';
...
$_['help_import_categories']     = 'Builds a Group structure in your store from the eBay categories';
