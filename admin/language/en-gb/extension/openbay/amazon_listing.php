...
// Buttons
$_['button_new'] 				  = 'Create new Package';
...
// Help
$_['help_sku'] 					  = 'Unique Package\'s ID assigned by the merchant';
...
// Text
$_['text_products_sent'] 		  = 'Packages were sent for processing';
...
$_['text_product_not_sent'] 	  = 'Package was not sent to Amazon. Reason: %s';
$_['text_not_in_catalog'] 		  = 'Or, if it is not in the catalog&nbsp;&nbsp;&nbsp;';
$_['text_placeholder_search'] 	  = 'Enter Package name, UPC, EAN, ISBN or ASIN';
$_['text_placeholder_condition']  = 'Use this box to describe the condition of your Packages.';
...
$_['text_product_sent'] 		  = 'Package was successfully sent to Amazon.';
$_['text_links_removed'] 		  = 'Amazon Package links deleted';
$_['text_product_links'] 		  = 'Package links';
$_['text_has_saved_listings'] 	  = 'This Package has one or more saved listings that is not uploaded';
...
$_['entry_to'] 					  = 'Date to';
$_['entry_Package'] 			  = 'Listing for Package';
$_['entry_Group'] 			  = 'Amazon Group';
...
$_['error_upload_failed'] 		  = 'Failed uploading Package with SKU: "%s". Reason: "%s" Uploading process canceled.';
...
$_['error_sending_Packages'] 	  = 'Could not send Packages for listing. Please contact support';
$_['error_no_Packages_selected']  = 'No Packages were selected for listing';
