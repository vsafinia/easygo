...
$_['text_return']                                     = 'Return to Packages';
$_['text_Group_suggested_help']                    = 'Based on your title';
$_['text_Group_popular_help']                      = 'Based on your history';
$_['text_Group_checking']                          = 'Checking eBay Group requirements, please wait';
$_['text_features_help']        	                  = 'Entering specifics about your item will help buyers narrow down the exact item they need. It may also improve the performance of the Package and eBay may score its best match value higher.';
...
$_['text_images_none']                                = 'You have no images for this Package, you must add images before you can list';
$_['text_width']      				                  = 'Width';
...
$_['entry_shop_Group']                             = 'Shop Group';
$_['entry_Group_popular']                          = 'Popular Categories';
$_['entry_Group_suggested']                        = 'eBay suggested Group';
$_['entry_Group']                                  = 'Group';
...
$_['help_Group_suggested']                         = 'The list of categories eBay has suggested based of your item title';
$_['help_Group_popular']       	                  = 'A list of your recently used categories';
$_['help_shop_Group']       		                  = 'The Group where the Package will be added in your eBay shop';
...
// Error
$_['error_choose_Group']    		                  = 'You must choose a Group';
$_['error_search_text']         	                  = 'Enter search text';
$_['error_no_stock']           		                  = 'You cannot list an item with zero stock';
$_['error_catalog_data']    		                  = 'No eBay catalog data was found for your Package in eBay';
$_['error_missing_settings']                          = 'You cannot list items until you sync the eBay settings';
$_['error_Group_load']   		                  = 'Unable to load categories';
$_['error_features']   				                  = 'Error loading features';
$_['error_catalog_load']   			                  = 'Error loading catalog';
$_['error_Group_sync']          	                  = 'You must fix your Group problem before you can list. Try re-syncing them in the module admin area.';
$_['error_sku']           			                  = 'Cannot submit a Package without an SKU';
$_['error_name']          			                  = 'Cannot submit a Package without a name';
$_['error_name_length']      		                  = 'Package name must be under 80 characters';
...
$_['error_listing_duration']      	                  = 'Select a listing duration, select Group to load these options';
