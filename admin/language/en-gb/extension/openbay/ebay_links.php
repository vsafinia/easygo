...
$_['error_no_listings']       = 'No linked Packages found';
$_['error_link_value']        = 'The Package link is not value';
$_['error_link_no_stock']     = 'A link cannot be created for an out of stock item. End the item manually on eBay.';
$_['error_subtract_setting']  = 'This Package is set not to subtract stock in EasyGo.';
...
$_['text_link_desc2']         = 'For each item that is updated the local stock (the stock available in your EasyGo store) will update your eBay listing';
...
$_['text_text_linked_desc']   = 'Linked items are EasyGo items that have a link to an eBay listing.';
$_['text_text_unlinked_desc'] = 'Unlinked items are listings on your eBay account that do not link to any of your EasyGo Packages.';
...
$_['column_product']          = 'Package';
$_['column_product_auto']     = 'Package name (auto complete)';
