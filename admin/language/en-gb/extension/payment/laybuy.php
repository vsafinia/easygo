...
$_['entry_Group']                = 'Allowed Categories';
$_['entry_Package_ids']             = 'Excluded Package IDs';
...
$_['help_Group']                 = 'Select for which categories the payment option will be available. Leave blank if no restriction.';
$_['help_Package_ids']              = 'Add Package IDs separated by comma(,) for which the method will not be available.';
