...
$_['entry_Package_count']          = 'Group Package Count';
...
$_['entry_tax_customer']           = 'Use Visitor Tax Address';
$_['entry_customer_online']        = 'Visitors Online';
$_['entry_customer_activity']      = 'Visitors Activity';
$_['entry_customer_search']        = 'Log Visitor Searches';
$_['entry_customer_group']         = 'Visitor Group';
$_['entry_customer_group_display'] = 'Visitor Groups';
...
$_['help_comment']                 = 'This field is for any special notes you would like to tell the visitor i.e. Store does not accept cheques.';
...
$_['help_limit_admin']   	       = 'Determines how many admin items are shown per page (orders, visitors, etc).';
$_['help_Package_count']           = 'Show the number of Packages inside the subcategories in the storefront header Group menu. Be warned, this will cause an extreme performance hit for stores with a lot of subcategories!';
...
$_['help_voucher_min']             = 'Minimum amount a visitor can purchase a voucher for.';
$_['help_voucher_max']             = 'Maximum amount a visitor can purchase a voucher for.';
$_['help_tax_default']             = 'Use the store address to calculate taxes if visitor is not logged in. You can choose to use the store address for the visitor\'s shipping or payment address.';
$_['help_tax_customer']            = 'Use the visitor\'s default address when they login to calculate taxes. You can choose to use the default address for the visitor\'s shipping or payment address.';
$_['help_customer_online']         = 'Track visitors online via the visitor reports section.';
$_['help_customer_activity']       = 'Track visitors activity via the visitor reports section.';
$_['help_customer_group']          = 'Default visitor group.';
$_['help_customer_group_display']  = 'Display visitor groups that new visitors can select to use such as wholesale and business when signing up.';
$_['help_customer_price']          = 'Only show prices when a visitor is logged in.';
$_['help_login_attempts']          = 'Maximum login attempts allowed before the account is locked for 1 hour. Visitor and affliate accounts can be unlocked on the visitor or affliate admin pages.';
...
$_['help_checkout_guest']          = 'Allow visitors to checkout without creating an account. This will not be available when a downloadable Package is in the shopping cart.';
$_['help_checkout']                = 'Forces people to agree to terms before a visitor can checkout.';
$_['help_order_status']            = 'Set the default order status when an order is processed.';
$_['help_processing_status']       = 'Set the order status the visitor\'s order must reach before the order starts stock subtraction and coupon, voucher and rewards redemption.';
$_['help_complete_status']         = 'Set the order status the visitor\'s order must reach before they are allowed to access their downloadable Packages and gift vouchers.';
$_['help_fraud_status']            = 'Set the order status when a visitor is suspected of trying to alter the order payment details or use a coupon, gift voucher or reward points that have already been used.';
$_['help_api']                     = 'Default API user the admin should use.';
$_['help_stock_display']           = 'Display stock quantity on the Package page.';
$_['help_stock_warning']           = 'Display out of stock message on the shopping cart page if a Package is out of stock but stock checkout is yes. (Warning always shows if stock checkout is no)';
$_['help_stock_checkout']          = 'Allow visitors to still checkout if the Packages they are ordering are not in stock.';
...
$_['help_ftp_root']                = 'The directory your EasyGo installation is stored in. Normally \'public_html/\'.';
...
$_['help_mail_alert']              = 'Select which features you would like to receive an alert email on when a visitor uses them.';
...
$_['help_maintenance']             = 'Prevents visitors from browsing your store. They will instead see a maintenance message. If logged in as admin, you will see the store as normal.';
...
$_['error_customer_group_display'] = 'You must include the default visitor group if you are going to use this feature!';
