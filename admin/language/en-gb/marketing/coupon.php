...
$_['help_Group']       = 'Choose all Packages under selected Group.';
$_['help_Package']        = 'Choose specific Packages the coupon will apply to. Select no Packages to apply coupon to entire cart.';
