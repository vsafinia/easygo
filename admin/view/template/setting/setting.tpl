          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Select Bidding Default Status">Bidding Enable/Disable</span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_bidding_status) { ?>
                        <input type="radio" name="config_bidding_status" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                      <?php } else { ?>
                        <input type="radio" name="config_bidding_status" value="1" />
                        <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_bidding_status) { ?>
                        <input type="radio" name="config_bidding_status" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                      <?php } else { ?>
                        <input type="radio" name="config_bidding_status" value="0" />
                        <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_review_guest; ?>"><?php echo $entry_review_guest.'/Bidding'; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
